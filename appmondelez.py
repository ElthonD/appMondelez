...
def load_df():
    ...
    rEmbarques = r'./data/Salidas Mondelez.xlsx'
...
try:
    ...
    st.markdown("<h2 style='text-align: left;'>Carga de Trabajo Operativa del Centro de Monitoreo para Mondelez</h2>", unsafe_allow_html=True)
    ...
    st.write(""" 
    La finalidad de este módulo es consultar el histórico de salidas de Mondelez y realizar seguimiento a la carga de trabajo. Pasos a seguir para este módulo:
    1. Seleccionar el **División** del cuál desea obtener información de salidas y carga de trabajo. Seleccionando el checkbox, puede seleccionar todas las divisiones de Mondelez.
    2. Seleccionar el **Mes** del cuál desea obtener información de salidas y carga de trabajo. Seleccionando el checkbox, puede seleccionar todos los meses del año.
       """)
